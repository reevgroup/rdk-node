...
export function generateHash(stringToHash: string): Promise<string> {
	...
	const argon2HashConfigOptions = { test: 'test', associatedData: buffer }; // Disallow the HASH_RAW option, see https://github.com/rdk/rdk/discussions/7670#discussioncomment-1255805
